...
const AttendanceCard = () => {
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-2 gap-2 Cards">
      
      <div className="bg-white p-4 rounded-lg shadow-md border-[1px]">
      ...
      <div className="bg-white p-2 rounded-lg shadow-md border-[1px]">
        <div className="flex flex-col items-center">
